...
-- - returns (number of cycles, f a)
--
tickForce :: (NFData a, NFData b) => (a -> b) -> a -> IO (Word64, b)
...
-- - returns (number of cycles, f a)
--
tickForceArgs :: (NFData a) => (a -> b) -> a -> IO (Word64, b)
...
ticksIO :: Int -> IO a -> IO ([Word64], a)
ticksIO = multiM tickIO
{-# INLINEABLE ticksIO #-}

stepTime :: StepMeasure IO Word64
...
time :: Measure IO Word64
time = Measure tick tickIO
{-# INLINEABLE time #-}

times :: Int -> Measure IO [Word64]
