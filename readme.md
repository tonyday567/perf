...
See [other/perf-examples.md](other/perf-examples.md) for output of an example analysis. Code for the benchmark runs can be found in [perf-examples/examples/perf-examples.hs](perf-analysis/examples/examples.hs). To create this readme locally run:
...
Comparison with criterion. See [other/perf-criterion.md](other/perf-criterion.md).
